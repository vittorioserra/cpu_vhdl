...
#
# make.tcl: Tcl script for re-creating project 'ex3_alu'
#
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/src/alu_tb.vhd"]"\
 "[file normalize "$origin_dir/../global_src/zedboard_master_XDC_RevC_D_v2.xdc"]"\
 "[file normalize "$origin_dir/src/alu_tb.wcfg"]"\
  ]
  foreach ifile $files {
...
set file "$origin_dir/src/alu_tb.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
