...
#
# make.tcl: Tcl script for re-creating project 'ex1_program_counter'
#
# Generated by Vivado on Tue May 09 17:30:14 CEST 2023
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/vivado/ex1_program_counter.srcs/utils_1/imports/synth_1/program_counter_demo.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set files [list \
 "[file normalize "$origin_dir/src/program_counter.vhd"]"\
 "[file normalize "$origin_dir/src/program_counter_tb.vhd"]"\
 "[file normalize "$origin_dir/src/program_counter_demo.vhd"]"\
 "[file normalize "$origin_dir/../global_src/zedboard_master_XDC_RevC_D_v2.xdc"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
...
set _xil_proj_name_ "ex1_program_counter"
...
set file "$origin_dir/src/program_counter.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/src/program_counter_tb.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set file "$origin_dir/src/program_counter_demo.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set obj [get_filesets sources_1]
set_property -name "top" -value "program_counter_demo" -objects $obj
...
set file "[file normalize "$origin_dir/../global_src/zedboard_master_XDC_RevC_D_v2.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../global_src/zedboard_master_XDC_RevC_D_v2.xdc"
set file [file normalize $file]
...
set obj [get_filesets sim_1]
set_property -name "top" -value "program_counter_tb" -objects $obj
...
set file "synth_1/program_counter_demo.dcp"
