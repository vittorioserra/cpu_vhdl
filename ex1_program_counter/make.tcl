...
#
# Generated by Vivado on Thu May 04 04:34:05 CEST 2023
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/src/zedboard_master_XDC_RevC_D_v2.xdc"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
...
set obj [get_runs synth_1]
set_property -name "incremental_checkpoint" -value "$proj_dir/ex1_program_counter.srcs/utils_1/imports/synth_1/program_counter_demo.dcp" -objects $obj
