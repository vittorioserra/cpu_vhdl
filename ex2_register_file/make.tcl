...
#
# make.tcl: Tcl script for re-creating project 'ex2_register_file'
#
# Generated by Vivado on Tue May 09 17:28:40 CEST 2023
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../global_src/utils.vhd"]"\
 "[file normalize "$origin_dir/src/regfile.vhd"]"\
 "[file normalize "$origin_dir/src/regfile_tb.vhd"]"\
 "[file normalize "$origin_dir/../global_src/zedboard_master_XDC_RevC_D_v2.xdc"]"\
 "[file normalize "$origin_dir/src/regfile_tb.wcfg"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "ex2_register_file"
...
set file "$origin_dir/../global_src/utils.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/src/regfile.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/src/regfile_tb.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set obj [get_filesets sim_1]
set_property -name "top" -value "regfile_tb" -objects $obj
